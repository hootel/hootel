    ...
    def get_line_graph_datas(self):
        ...
        #~ if show_date != today:
            ...
            #~ for day in range(0,number_day_to_add):
                ...
                #~ short_name = format_date(show_date, 'd MMM', locale=locale)
                #~ data.append({'x': short_name, 'y':last_balance, 'name': name})
        data = ({'name': '27 December 2017', 'x':'27', 'y': 80},
                {'name': '28 December 2017', 'x':'28', 'y': 40},
                {'name': '29 December 2017', 'x':'29', 'y': 60},
                {'name': '30 December 2017', 'x':'30', 'y': 120},
                {'name': '31 December 2017', 'x':'31', 'y': 90},
                {'name': '1 January 2017', 'x':'1', 'y': 56},
                {'name': '2 January 2017', 'x':'2', 'y': 66},
                {'name': '3 January 2017', 'x':'3', 'y': 44},
                {'name': '4 January 2017', 'x':'4', 'y': 13},
                {'name': '5 January 2017', 'x':'5', 'y': 43},
                {'name': '6 January 2017', 'x':'6', 'y': 34},
                {'name': '7 January 2017', 'x':'7', 'y': 130},
                {'name': '8 January 2017', 'x':'8', 'y': 53},
                {'name': '9 January 2017', 'x':'9', 'y': 9},
                {'name': '10 January 2017', 'x':'10', 'y': 34},
                {'name': '11 January 2017', 'x':'11', 'y': 80},
                {'name': '12 January 2017', 'x':'12', 'y': 66},
                {'name': '13 January 2017', 'x':'13', 'y': 40},
                {'name': '14 January 2017', 'x':'14', 'y': 13},
                {'name': '15 January 2017', 'x':'15', 'y': 43},
                {'name': '16 January 2017', 'x':'16', 'y': 34},
                {'name': '17 January 2017', 'x':'17', 'y': 130},
                {'name': '18 January 2017', 'x':'18', 'y': 53},
                {'name': '19 January 2017', 'x':'19', 'y': 76},
                {'name': '20 January 2017', 'x':'20', 'y': 34},
                {'name': '21 January 2017', 'x':'21', 'y': 5},
                {'name': '22 January 2017', 'x':'22', 'y': 66},
                {'name': '23 January 2017', 'x':'23', 'y': 34},
                {'name': '24 January 2017', 'x':'24', 'y': 13},
                {'name': '25 January 2017', 'x':'25', 'y': 43},
