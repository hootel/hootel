...
"""
            ...
            for line in lines:
                if ((line.partner_id.document_type is not False)
                    ...
                    and (line.partner_id.document_expedition_date)):

                    log_police += 1
                    if line.partner_id.document_type in ['D', 'C'] or \
                        (line.partner_id.document_type == 'P' and
                         line.partner_id.nationality_id.code_numeric == '724'):
